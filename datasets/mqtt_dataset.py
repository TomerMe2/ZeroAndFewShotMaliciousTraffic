...
class MqttDataset(TrafficDataset):
    ...
    def __init__(self, path, is_train, lbl_is_src_ip, include_malicious_traffic, test_size=0.2):        
        super().__init__(path, is_train, lbl_is_src_ip,include_malicious_traffic, 
                        ...
                        categorical_clms=['protocol', 'ip_flag_df','ip_flag_mf','ip_flag_rb','tcp_flag_res','tcp_flag_ns','tcp_flag_cwr','tcp_flag_ecn','tcp_flag_urg','tcp_flag_ack','tcp_flag_push','tcp_flag_reset','tcp_flag_syn','tcp_flag_fin','mqtt_messagetype','mqtt_messagelength','mqtt_flag_uname','mqtt_flag_passwd','mqtt_flag_retain','mqtt_flag_qos','mqtt_flag_willflag','mqtt_flag_clean','mqtt_flag_reserved'],
