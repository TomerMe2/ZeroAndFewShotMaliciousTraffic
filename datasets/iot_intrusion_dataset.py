...
class IotIntrusionDataset(TrafficDataset):
    ...
    def __init__(self, path, is_train, lbl_is_src_ip, include_malicious_traffic, test_size=0.2):        
        super().__init__(path, is_train, lbl_is_src_ip,
                         include_malicious_traffic, src_ip_clm_nm='Src_IP',
                         dst_ip_clm_nm='Dst_IP', label_clm_nm='Sub_Cat',
                         ...
                         benign_label_in_dataset='Normal', test_size=test_size)